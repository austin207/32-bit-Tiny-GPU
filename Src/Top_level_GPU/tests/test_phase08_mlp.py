...
async def test_mlp_inference(dut):
    ...
    path = os.path.join(base, "../../assembler/builds/bin/phase8_mlp_inference.axelbin")
    ...
    if kc is None:
        ...
        assert False, f"phase8 hung after {elapsed} cycles"
    ...
    assert all_pass, "phase8 output mismatch"